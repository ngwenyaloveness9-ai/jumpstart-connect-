...
import { LogOut, User, Bell, Moon, Sun, Layers, MessageSquare } from "lucide-react";
import { useTheme } from "./ThemeProvider";
import { Messages } from "./admin/Messages";
import { Workspaces } from "./admin/Workspaces";

const TABS = [
  { id: "workspaces", label: "Workspaces", icon: Layers, description: "Groups you're a part of" },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="border-b border-border px-6 py-4 flex items-center justify-between sticky top-0 bg-background/80 backdrop-blur-sm z-40">
        <div className="flex items-center gap-3">
          ...
          <span className="font-semibold text-foreground">Jumpstart Connect</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5 pl-3 border-l border-border">
            ...
            <div className="hidden sm:block">
              <p className="text-xs font-medium text-foreground leading-none">{userName || "Account"}</p>
      ...
      <main className="max-w-6xl mx-auto px-6 py-10 space-y-8">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-primary/15 via-card to-card p-8">
          ...
          <div className="relative">
            ...
            <p className="text-muted-foreground text-sm">Here's what's happening across your workspaces today.</p>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center gap-2.5 mb-4">
            <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
              <active.icon size={15} className="text-primary" />
            </div>
            <div>
              <h2 className="text-sm font-semibold text-foreground leading-none">{active.label}</h2>
