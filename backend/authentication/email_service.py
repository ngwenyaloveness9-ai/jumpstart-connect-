          ...
          <div style="max-width:600px; margin:0 auto; background:#ffffff; border:1px solid #e5e5e5; border-radius:16px; overflow:hidden;">
            ...
            <div style="padding:32px;">
              ...
              <p style="margin:0 0 18px; font-size:15px; line-height:1.7; color:#0D0D0D;">
                Your employee account has been created successfully. Use the one-time PIN below to complete your first sign in with your work email.
              </p>
              ...
              <p style="margin:0 0 16px; font-size:15px; line-height:1.7; color:#0D0D0D;">
                This PIN does not expire and can be used only once. After the first sign in, you will be redirected to create your password.
              </p>
